...
puzzle_input = '''una bokpr ftz ryw nau yknf fguaczl anu
...
for line in puzzle_input.split('\n'):
    ...
    for index_1, word_1 in enumerate(counter.keys()):
        for index_2, word_2 in enumerate(counter.keys()):
            if index_1 != index_2:
                if is_anagram(word_1, word_2):
                    no_anagrams = False
                    break
    if counter.most_common(1)[0][1] == 1 and no_anagrams:
        count += 1
